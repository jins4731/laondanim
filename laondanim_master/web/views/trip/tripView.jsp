            ...
            <div class="row pl-2">
                <div class="d-flex col-3">
                    <a id="courseTypeBt" onclick="courseTypeBt()" href="javascript:void(0)"
                        class="col-5 d-block btn btn-indigo py-1 active">
                        코스
                    </a>
                    <a id="reviewTypeBt" onclick="reviewTypeBt()" href="javascript:void(0)"
                        class="col-5 d-block btn btn-indigo ml-3 py-1 ">
                        후기
                    </a>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div id="dayContainer" class="col-11">
						...
						<%for(int i = 0;i < tripSchedulList.size();i++){ 
							...
							TripSchedule ts = tripSchedulList.get(i);
							int day = ts.getDay();
							int order = ts.getOrders();
							int tripinfoNo = ts.getTripinfoNo();
							int tripNo = ts.getTripNo();
							String time = ts.getRequiredHours();
							String transport = ts.getTransport();
						
						
						%>
						
							<%if(i == 0){ %>
								<div id="day<%=day %>" class="col-11">
							<%} %>
							
							
							<%if(i == 0){ %>
							 <div id="day<%=day %>" class="row">
                        ...
                        <!-- 첫째줄 -->
                            ...
                            <div name="day1_1_2" onclick="scheduleItemBt()" data-save="2" class="col text-center p-2"
                                ...
                                <div class="col "
                                    style="position: absolute;top:25px;left: 155px;width: 80px;height:50px">
                        ...
                        <div class="row">
                            ...
                            <div name="day1_2_1" onclick="scheduleItemBt()" data-save="8"
                                ...
                                <div class="col "
                                    ...
                                    <img class="filp"
                                        src="<%=request.getContextPath() %>/picture/trip/icon/airplane.png" width="40px"
                                        height="25px" alt="">
                                    <span>33분</span>
                                </div>

                                <div class="col "
                                    style="position: absolute;top:0px;left: 155px;width: 80px;height:50px">
