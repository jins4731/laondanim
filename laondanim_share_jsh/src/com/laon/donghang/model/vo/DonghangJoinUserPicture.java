...
//동행 테이블
public class DonghangJoinUserPicture {
 ...
 public DonghangJoinUserPicture() {
...
public DonghangJoinUserPicture(int no, int userNo, int tripNo, Date writeDate, int viewcount, String tag, String title,
		...
		int joinPeopleNo, String nickName, String image) {
	super();
	this.no = no;
	this.userNo = userNo;
	this.tripNo = tripNo;
...
public String toString() {
	return "DonghangJoinUserPicture [no=" + no + ", userNo=" + userNo + ", tripNo=" + tripNo + ", writeDate="
			+ writeDate + ", viewcount=" + viewcount + ", tag=" + tag + ", title=" + title + ", content=" + content
			...
			+ ", recruitPeopleNo=" + recruitPeopleNo + ", joinPeopleNo=" + joinPeopleNo + ", nickName=" + nickName
			+ ", image=" + image + "]";
}
...
// DonghangTb 모델 복사
 public void CopyData(DonghangJoinUserPicture param)
 {
     this.no = param.getNo();
