...
public class Paging {
	...
	public String pageBar(String url, int totalData, int cPage, int perPage, String keyword, String category, String lo) {
		...
		if(rowNum == 1) {
			...
			pageBar += "<li class='page-item'><a class='page-link' href='"+url+"?cPage=" + (rowNum-1) +"&keyword="+keyword+"&category="+category+"&lo"+lo+"' area-label='Previous'>&lt;</a></li>";
		}
		...
		while(!(rowNum>pageLast || rowNum>totalPage)) {
			if(cPage==rowNum) {
				...
				pageBar += "<li class='page-item'><a class='page-link' href='"+url+"?cPage="+rowNum+"&keyword="+keyword+"&category="+category+"&lo"+lo+"'>"+rowNum+"</a></li>";
			}
			rowNum++;
		}
		...
		if(rowNum>totalPage) {
			...
			pageBar +="<li class='page-item'><a class='page-link' href='"+url+"?cPage="+rowNum+"&keyword="+keyword+"&category="+category+"&lo"+lo+"' area-label='Previous'>&gt;</a></li>";
		}
