...
public class TripMyCon {
	...
	public TripMyCon(int no, int userTbNo, String category, Date writeDate, String[] tag, String title, String content,
			String tripLocate, int peopleNum, String tripType, Date startDate, Date endDate, char publicEnabled,
			char deleted, String image) {
		super();
		this.no = no;
